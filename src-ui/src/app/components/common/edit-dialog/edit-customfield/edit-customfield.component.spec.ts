...
import { EditCustomfieldComponent, EditCustomfieldMode } from './edit-customfield.component'
...
class TestComponent extends EditCustomfieldComponent<Tag> {
  constructor(
    service: TagService,
...
describe('EditCustomfieldComponent', () => {
  ...
  it('should interpolate object permissions', () => {
    ...
    component.customfieldMode = EditCustomfieldMode.EDIT
    component.ngOnInit()
  ...
  it('should set default owner when in create mode if unset', () => {
    component.customfieldMode = EditCustomfieldMode.CREATE
    component.ngOnInit()
