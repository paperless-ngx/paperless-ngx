...
import { EditCustomBoxComponent, EditCustomshelfdMode } from './edit-custombox.component'
...
class TestComponent extends EditCustomBoxComponent<Tag> {
  [x: string]: any
  constructor(
    service: TagService,
...
describe('EditCustomBoxComponent', () => {
  ...
  it('should interpolate object permissions', () => {
    ...
    component.customshelfdMode = EditCustomshelfdMode.EDIT
    component.ngOnInit()
  ...
  it('should set default owner when in create mode if unset', () => {
    component.customshelfMode = EditCustomshelfdMode.CREATE
    component.ngOnInit()
  ...
  it('should set default perms when in create mode if set', () => {
    component.customshelfdMode = EditCustomshelfdMode.CREATE
  ...
  it('should support create and edit modes', () => {
    ...
    component.customshelfMode = EditCustomshelfdMode.EDIT
    fixture.detectChanges()
    expect(editTitleSpy).toHaveBeenCalled()
    // coverage
    component.customfieldMode = null
    fixture.detectChanges()
  })
