...
@Component({
  selector: 'pngx-dossier-card-small',
  templateUrl: './dossier-card-small.component.html',
  styleUrls: ['./dossier-card-small.component.scss'],
})
export class DossierCardSmallComponent extends ComponentWithPermissions {
  constructor(
