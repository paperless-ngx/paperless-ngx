...
@Component({
  selector: 'pngx-folder-card-large',
  templateUrl: './folder-card-large.component.html',
  styleUrls: ['./folder-card-large.component.scss'],
})
export class FolderCardLargeComponent extends ComponentWithPermissions {
