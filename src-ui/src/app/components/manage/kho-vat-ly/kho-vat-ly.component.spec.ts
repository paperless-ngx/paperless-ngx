...
describe('KhoVatLyComponent', () => {
  let component: KhoVatLyComponent
  let fixture: ComponentFixture<KhoVatLyComponent>
  let khoVatLyService: KhoVatLyService
  ...
  beforeEach(() => {
    ...
    khoVatLyService = TestBed.inject(KhoVatLyService)
    jest.spyOn(khoVatLyService, 'listAll').mockReturnValue(
      of({
        count: fields.length,
    ...
    fixture = TestBed.createComponent(KhoVatLyComponent)
  ...
  it('should support delete, show notification on error / success', () => {
    ...
    modalService.activeInstances.subscribe((m) => (modal = m[m.length - 1]))
    const toastErrorSpy = jest.spyOn(toastService, 'showError')
    const deleteSpy = jest.spyOn(khoVatLyService, 'delete')
    const reloadSpy = jest.spyOn(component, 'reload')
