...
export const ConfigCategory = {
  ...
  Compress: $localize `Compress Settings`
}
...
export const EdocConfigOptions: ConfigOption[] = [
  {
    key: 'enable_ocr',
  ...
  {
    key: 'enable_compress',
    title: $localize`Enable Compress`,
    type: ConfigOptionType.Boolean,
    config_key: 'PAPERLESS_COMPRESS_ENABLE',
    category: ConfigCategory.Compress,
  },
  // {
  //   key: 'output_type',
  ...
  // },
  {
    key: 'quality_compress',
    title: $localize`Quanlity compress`,
    type: ConfigOptionType.Number,
    config_key: 'PAPERLESS_COMPRESS_QUANLITY',
    category: ConfigCategory.Compress,
  },
  // {
  //   key: 'language',
...
export interface EdocConfig extends ObjectWithId {
  enable_ocr: boolean
  enable_compress: boolean
  quality_compress: number
