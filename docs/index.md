...
-   Performs **OCR** on your documents, adding selectable text to image-only documents and makes their content searchable.
    - Paperless utilizes the open-source Tesseract engine to recognize more than 100 languages.
-   All documents are saved as PDF/A, a special file format intended for long term storage, alongside to the unaltered originals.
