...
| **Matching specific tags, correspondents or types** | `type:invoice tag:unpaid`              | Find documents of type "invoice" that have the "unpaid" tag.                                                             |
|                                                     | `correspondent:university certificate` | Find documents from the correspondent "university" that contain the word "certificate".                                  |
| **Matching dates**                                  | `created:[2005 to 2009]`               | Find documents created between 2005 and 2009.                                                                            |
|                                                     | `added:yesterday`                      | Find documents added yesterday.                                                                                          |
|                                                     | `modified:today`                       | Find documents modified today.                                                                                           |
