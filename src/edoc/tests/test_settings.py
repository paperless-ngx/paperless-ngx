...
from edoc.settings import _parse_base_paths
from edoc.settings import _parse_beat_schedule
from edoc.settings import _parse_db_settings
from edoc.settings import _parse_ignore_dates
from edoc.settings import _parse_edoc_url
from edoc.settings import _parse_redis_url
from edoc.settings import default_threads_per_worker
...
class TestThreadCalculation(TestCase):
    def test_workers_threads(self):
        ...
        for i in range(1, 64):
            with mock.patch(
                "edoc.settings.multiprocessing.cpu_count",
            ) as cpu_count:
...
class TestEdocURLSettings(TestCase):
...
class TestPathSettings(TestCase):
    ...
    def test_subpath(self):
        ...
        """
        base_paths = _parse_base_paths()
        self.assertEqual("/edoc", base_paths[0])  # FORCE_SCRIPT_NAME
        self.assertEqual("/edoc/", base_paths[1])  # BASE_URL
        self.assertEqual("/edoc/accounts/login/", base_paths[2])  # LOGIN_URL
        self.assertEqual("/edoc/dashboard", base_paths[3])  # LOGIN_REDIRECT_URL
        self.assertEqual("/edoc/", base_paths[4])  # LOGOUT_REDIRECT_URL
