...
INSTALLED_APPS = [
    ...
    "edoc_tesseract.apps.PaperlessTesseractConfig",
    "edoc_ocr_custom.apps.PaperlessTesseractConfig",
    "edoc_text.apps.PaperlessTextConfig",
    "edoc_mail.apps.PaperlessMailConfig",
...
def _parse_remote_user_settings() -> str:
    ...
    if enable_api:
        REST_FRAMEWORK["DEFAULT_AUTHENTICATION_CLASSES"].insert(
            0,
            "edoc.auth.PaperlessRemoteUserAuthentication",
        )
...
def _parse_db_settings() -> dict:
    ...
    if os.getenv("PAPERLESS_DBHOST"):
        ...
        databases["default"] = {
            ...
            "NAME": os.getenv("PAPERLESS_DBNAME", "edoc"),
            "USER": os.getenv("PAPERLESS_DBUSER", "edoc"),
            "PASSWORD": os.getenv("PAPERLESS_DBPASS", "edoc"),
            "OPTIONS": {},
        }
...
if TIKA_ENABLED:
    INSTALLED_APPS.append("edoc_tika.apps.PaperlessTikaConfig")
