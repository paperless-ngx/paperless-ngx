...
from paperless.settings import (
    _get_celery_broker_config,
    _get_channel_layers_config,
...
class RedisSentinelConfigTest(TestCase):
    ...
    def test_sentinel_hosts_without_ports(self):
        ...
        os.environ["PAPERLESS_REDIS_SENTINEL_HOSTS"] = "sentinel1,sentinel2:26380,sentinel3"
        
        config = _parse_redis_sentinel_config()
        
        expected_hosts = [("sentinel1", 26379), ("sentinel2", 26380), ("sentinel3", 26379)]
    ...
    def test_sentinel_hosts_with_spaces(self):
        ...
        os.environ["PAPERLESS_REDIS_SENTINEL_HOSTS"] = " sentinel1:26379 , sentinel2:26380 "
...
class ChannelLayersConfigTest(TestCase):
    ...
    def test_channel_layers_with_sentinel(self):
        ...
        self.assertEqual(config["default"]["BACKEND"], "channels_redis.pubsub.RedisPubSubChannelLayer")
        ...
        self.assertEqual(config["default"]["CONFIG"]["connection_kwargs"], expected_connection)
    ...
    def test_channel_layers_without_sentinel(self):
        ...
        self.assertEqual(config["default"]["BACKEND"], "channels_redis.pubsub.RedisPubSubChannelLayer")
        self.assertEqual(config["default"]["CONFIG"]["hosts"], ["redis://localhost:6379"])
