...
INSTALLED_APPS = [
    ...
    "paperless_mistralocr.apps.PaperlessMistralOcrConfig",
...
EMBEDDING_ENABLED = __get_boolean("PAPERLESS_EMBEDDING_ENABLED", "false")
EMBEDDING_PROVIDER = os.getenv("PAPERLESS_EMBEDDING_PROVIDER", "mistralai")
