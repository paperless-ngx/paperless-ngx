...
EXTERNAL_AUTH_ALLOWED_REDIRECT_URIS = __get_list(
    "PAPERLESS_EXTERNAL_AUTH_ALLOWED_REDIRECT_URIS",
)
EXTERNAL_AUTH_CODE_TTL_SECONDS = max(
    __get_int("PAPERLESS_EXTERNAL_AUTH_CODE_TTL_SECONDS", 60),
    1,
)
EXTERNAL_AUTH_FLOW_TTL_SECONDS = max(
    __get_int("PAPERLESS_EXTERNAL_AUTH_FLOW_TTL_SECONDS", 600),
    1,
)
