# Migration to enable PostgreSQL Row-Level Security (RLS) for ShareLink
...
def enable_sharelink_rls_forward(apps, schema_editor):
    """
...
def disable_sharelink_rls_reverse(apps, schema_editor):
    """
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(enable_sharelink_rls_forward, reverse_code=disable_sharelink_rls_reverse),
    ]
