...
from edoc_mail import tasks
from edoc_mail.mail import MailAccountHandler
from edoc_mail.mail import MailError
from edoc_mail.mail import TagMailAction
from edoc_mail.mail import apply_mail_action
...
@mock.patch("edoc_mail.mail.magic.from_buffer", fake_magic_from_buffer)
class TestMail(
    DirectoriesMixin,
    ...
    def setUp(self):
        ...
        patcher = mock.patch("edoc_mail.mail.MailBox")
        m = patcher.start()
        m.return_value = self.bogus_mailbox
        self.addCleanup(patcher.stop)

        patcher = mock.patch("edoc_mail.mail.queue_consumption_tasks")
    ...
    @mock.patch("edoc_mail.mail.MailAccountHandler._get_correspondent")
    ...
    def test_error_create_correspondent(self):
        ...
        with mock.patch("edoc_mail.mail.Correspondent.objects.get_or_create") as m:
...
class TestManagementCommand(TestCase):
    @mock.patch(
        "edoc_mail.management.commands.mail_fetcher.tasks.process_mail_accounts",
    )
...
class TestTasks(TestCase):
    @mock.patch("edoc_mail.tasks.MailAccountHandler.handle_mail_account")
