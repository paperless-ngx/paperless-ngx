...
from edoc.tests.test_parsers import BaseMailParserTestCase
...
class TestParserLive(FileSystemAssertsMixin, BaseMailParserTestCase):
    ...
    @mock.patch("edoc.parsers.MailDocumentParser.generate_pdf")
    ...
    @mock.patch("edoc.parsers.MailDocumentParser.generate_pdf_from_mail")
    @mock.patch("edoc.parsers.MailDocumentParser.generate_pdf_from_html")
