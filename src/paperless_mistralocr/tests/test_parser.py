...
class TestMistralOcrParser(TestCase):
    ...
    @mock.patch("paperless_mistralocr.parsers.MistralOcrDocumentParser._call_mistral_api")
    def test_parse_basic(self, mock_call_api):
        ...
        # Verify results
        self.assertEqual(self.parser.text, "# Sample Document\n\nThis is a test document.")
    ...
    def test_api_call(self, mock_mistral):
        ...
        # Mock settings
        with mock.patch("paperless_mistralocr.parsers.MistralOcrDocumentParser.get_settings") as mock_settings:
